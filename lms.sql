...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 12, 2025 at 04:14 PM
...
INSERT INTO `membership_type` (`type_id`, `type_name`, `duration_months`, `annual_fee`) VALUES
(1, 'Regular', 12, 500.00),
...
ALTER TABLE `members`
  ...
  ADD CONSTRAINT `members_ibfk_2` FOREIGN KEY (`type_id`) REFERENCES `membership_type` (`type_id`);
